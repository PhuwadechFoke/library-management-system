...
export default function CategoryForm({ updateData = {}, loading, adminId }) {
  ...
  const onSubmit = async (data) => {
    // ⚠️ เพิ่มการตรวจสอบว่ามีการใส่ข้อมูลชื่อหมวดหมู่หรือไม่
    if (!data.title) {
    ...
    // หากในอนาคตมีฟิลด์ตัวเลขเพิ่มเข้ามา เช่น "ลำดับการแสดงผล" 
    // เราสามารถใช้ pattern นี้ดักจับได้เลย (ป้องกัน NaN แครชหน้าจอ)
